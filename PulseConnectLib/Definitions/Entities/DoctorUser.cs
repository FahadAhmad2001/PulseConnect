...
namespace PulseConnectLib.Definitions.Entities
{
    public class DoctorUser : User
    {
        ...
        public void CreateNewDoctorUser(string username, string hashedpassword, ProviderClass userType, string currentSessionID, DateTime sessionExpiry, 
            DateTime creatingDate, bool canStartRapidResponses, bool ReceiveRRTAlerts, List<string> ListOfGroups, bool CanTransfer)
        {
